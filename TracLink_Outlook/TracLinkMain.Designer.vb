...
Partial Public NotInheritable Class TracLinkMain
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _TracLinkMain As TracLinkMain
    ...
    Friend Shared Property TracLinkMain() As TracLinkMain
        Get
            Return _TracLinkMain
        End Get
        Set
            If (_TracLinkMain Is Nothing) Then
                _TracLinkMain = value
            Else
    ...
    Friend Shared ReadOnly Property FormRegions() As ThisFormRegionCollection
        Get
            If (_ThisFormRegionCollection Is Nothing) Then
                _ThisFormRegionCollection = New ThisFormRegionCollection(Globals.TracLinkMain.GetFormRegions)
            End If
...
Partial Friend NotInheritable Class ThisFormRegionCollection
    ...
    Friend Overloads Default ReadOnly Property Item(ByVal explorer As Microsoft.Office.Interop.Outlook.Explorer) As WindowFormRegionCollection
        Get
            Return CType(Globals.TracLinkMain.GetFormRegions(explorer, GetType(WindowFormRegionCollection)),WindowFormRegionCollection)
        End Get
    End Property
    ...
    Friend Overloads Default ReadOnly Property Item(ByVal inspector As Microsoft.Office.Interop.Outlook.Inspector) As WindowFormRegionCollection
        Get
            Return CType(Globals.TracLinkMain.GetFormRegions(inspector, GetType(WindowFormRegionCollection)),WindowFormRegionCollection)
        End Get
    End Property
End Class
